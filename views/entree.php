                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        ?>
                                            <td>
                                                <a href="entree.php?Franc&Fc&idEntreeFc=<?= $EntreeDol["id"] ?>" class="btn btn-dark btn-sm">
                                                    <i class="bi bi-pencil-square"></i>
                                                </a>
                                                <a href="entree.php?SupTer=<?= $EntreeDol["id"] ?>" class="btn btn-danger btn-sm">
                                                    <i class="bi bi-trash3-fill"></i>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <p class="card-text">
                                            <a href="entree.php?dollar" class="btn btn-dark btn-sm w-100">Dollars / "$"</a>
                                        </p>
                                    </div>
                                    <div class="col-lg-6">
                                        <p class="card-text">
                                            <a href="entree.php?Franc" class="btn btn-dark btn-sm w-100">Francs / "Fc"</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
